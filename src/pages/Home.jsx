                                      ...
                                      <div className="card card-animate">
                                          <div className="card-body home-card border-1">
                                              ...
                                              <div className="d-flex align-items-end justify-content-between mt-4">
                                                  <div>
                                                      <h4 className="fs-22 fw-semibold ff-secondary mb-4"><span className="counter-value" data-target="0">0</span> <small className="fs-12">İşyeri </small> </h4>
                                                  </div>
                                  ...
                                  <div className="col-xl-4 col-md-6">
                                      <div className="card card-animate">
                                          <div className="card-body home-card border-1">
                                              ...
                                              <div className="d-flex align-items-end justify-content-between mt-4">
                                                  <div>
                                                      <h4 className="fs-22 fw-semibold ff-secondary mb-4"><span className="counter-value" data-target="0">0</span> <small className="fs-12">Kuruluş </small> </h4>
                                                  </div>
                                                  <div className="avatar-sm flex-shrink-0">
                                                      <span className="avatar-title bg-success rounded fs-3">
                                  ...
                                  <div className="col-xl-3 col-md-6">
                                      <div className="card card-animate">
                                          <div className="card-body home-card border-1">
                                              ...
                                              <div className="d-flex align-items-end justify-content-between mt-4">
                                                  <div>
                                                      <h4 className="fs-22 fw-semibold ff-secondary mb-4"><span className="counter-value" data-target="0">0</span> <small className="fs-12">Açık </small> <span className="counter-value" data-target="0">0</span> <small className="fs-12"> Kapalı </small> </h4>
                                                      <h4 className="fs-22 fw-semibold ff-secondary mb-4"> </h4>
                                                  </div>
                                                  <div className="avatar-sm flex-shrink-0">
