...
export default function NewUserForm() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="">
      ...
      <div className="">
      <select {...register("paymentInstitution", { required: true })} className="p-2 w-100 bg-gray-100 rounded-lg">
      ...
      <div >
      <select {...register("department", { required: true })} className="p-2 w-100 bg-gray-100 rounded-lg">
      ...
      <div className="flex flex-col gap-3 justify-between">
      <div>
      <select {...register("userType", { required: true })} className="p-2 w-100 bg-gray-100 rounded-lg">
      ...
      {errors.gsm && (
        ...
        <div>
      <select {...register("smsVerification", { required: true })} className="p-2 bg-gray-100 rounded-lg">
